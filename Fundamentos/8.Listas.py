#Listas list()
# Inicialización [] ---> Se inicializa por corchetes 
# Listas no tiene un espacio definido  ---> No tiene reserva fija
...
# Indexación
# Averiguar el largo o número de elementos que tiene una lista
print(len(lista2))
...
#lista alumnos
listaAlumnos = ['Kevin','Andres','Cristo','Janeth','Mario']
...
# Retirar elementos
#POP Para indices de elementos
# pop tiene el indice del final como default si no se le cambia
listaAlumnos2.pop()
print(listaAlumnos2)
...
# Operador 
print('Kevin' in listaAlumnos2) #Existe un Kevin en la lista?
print('Samatha' in listaAlumnos2) #Existe una Samatha en la lista?

# Hacer una copia
copialistaAlumnos = listaAlumnos2[::] #Todos los elementos --> [::]
print(copialistaAlumnos)
copialistaAlumnos2 = listaAlumnos2.copy() #Metodo copy
print(copialistaAlumnos2)

#Invertir la copia
print(copialistaAlumnos[::-1])
copialistaAlumnos2.reverse() #Metodo para reverso de las listas
print(copialistaAlumnos2)
...
lista4 = [85,47,68,25]
lista4.sort(reverse=True) #Orden descendente si reverse=true
print(lista4)
...
print(listadeTexto) #DE UNO EN UNO 
